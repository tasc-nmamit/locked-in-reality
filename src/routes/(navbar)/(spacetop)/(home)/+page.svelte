<main class="min-h-[100dvh] overflow-x-hidden">
	<div class="top-64 hidden min-h-screen w-[100vw] items-center justify-center md:flex">
		<div class="z-30 flex translate-y-[-10%] flex-col items-center md:flex-row-reverse">
			<img src="/assets/centerGraphic.jpeg" alt="Center Graphic" class="brightness-90 md:scale-50 lg:scale-50" />
			<div class="z-50 flex flex-col md:pl-6">
				<div class="istok_web bg-gradient-to-r from-brand to-[#cc99ff] to-[22%] bg-clip-text md:text-6xl lg:text-[5rem]">
					<p class="text-transparent">Locked In Reality</p>
				</div>
	...
	<div class="flex min-h-[100dvh] flex-grow flex-col md:hidden">
		<div class="z-0 flex flex-col">
			<div class="flex w-full translate-y-[-10%] flex-col items-center px-2">
				<img src="/assets/centerGraphic.jpeg" alt="Center Graphic" class="translate-y-[5dvh] scale-50 brightness-90 md:translate-y-[6dvh]" />
			...
			<div class="flex w-full justify-center px-2">
				<p class="text-center text-sm">Can you compete with the superior species!<br /> <span class="font-bold">Made with love by Dept. of AIML</span></p>
			</div>
